...
Chúng tôi sử dụng cookie và các công nghệ tương tự để phân tích lưu lượng truy cập và cải thiện trải nghiệm người dùng. Bạn có thể quản lý cookie trong cài đặt trình duyệt. Một số tính năng có thể không hoạt động đúng nếu cookie bị tắt.
...
Chúng tôi lưu giữ thông tin trong thời gian cần thiết để thực hiện các mục đích nêu trong chính sách này, tuân thủ nghĩa vụ pháp lý, giải quyết tranh chấp và thực thi thỏa thuận.

## Bảo mật

Chúng tôi áp dụng các biện pháp bảo vệ hợp lý về quản trị, kỹ thuật và vật lý. Không có phương thức truyền hoặc lưu trữ nào an toàn tuyệt đối, vì vậy chúng tôi không thể đảm bảo bảo mật hoàn toàn.

## Quyền và lựa chọn của bạn

Tùy theo nơi bạn sinh sống, bạn có thể có quyền truy cập, chỉnh sửa, xóa hoặc phản đối một số hoạt động xử lý thông tin cá nhân.

### Hoa Kỳ, bao gồm California
...
Để thực hiện các quyền của mình, hãy liên hệ với chúng tôi tại **{{ site.email }}**.

## Quyền riêng tư của trẻ em

Dịch vụ của chúng tôi không hướng đến trẻ em dưới 13 tuổi và chúng tôi không cố ý thu thập thông tin cá nhân của trẻ em. Nếu bạn cho rằng một trẻ em đã cung cấp thông tin cho chúng tôi, vui lòng liên hệ để chúng tôi xóa thông tin đó.

## Cập nhật chính sách

Chúng tôi có thể cập nhật Chính sách bảo mật này theo thời gian. Phiên bản mới sẽ được đăng trên trang này và ngày có hiệu lực ở trên sẽ được cập nhật.

## Liên hệ

Nếu có câu hỏi về Chính sách bảo mật hoặc cách chúng tôi xử lý dữ liệu, vui lòng liên hệ **{{ site.email }}**.
